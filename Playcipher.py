...
##########################################################################
#while loop for selecting operations to be performed
##########################################################################
while(flag == 1):
    if(x == '1'):
        print('************************************')
        print('Playfair encryption tool (P.E.T)')
        print('Yashwanth Reddy Muddireddy\n')
        print('************************************')
        ...
        #takes two letters from message to encrypt using key
        while (coordinate<(len(newMessage)-1)):
            text = myCipher.getCodedDigraph([newMessage[coordinate],newMessage[coordinate+1]])    
            cipherText = cipherText + str.join(text)
        ...
        #takes two letters from message to decrypt using key
        while (coordinate<(len(newMessage)-1)):
            text = myCipher.getDecodedDigraph([newMessage[coordinate],newMessage[coordinate+1]])    
            cipherText = cipherText + str.join(text)
            coordinate=coordinate+2
